          ...
          {step === 'choose' ? (
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <button onClick={() => googleOAuthLogin()} disabled={loading} className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 dark:border-gray-700 dark:bg-dark-surfaceAlt p-4 rounded-xl font-bold hover:bg-gray-50 transition-all shadow-sm disabled:opacity-50">
